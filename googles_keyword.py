...
def get_command_line_args():
    ...
    parser.add_argument('--csvpath', default='out', type=str, help='Path to save the exported csv file. By default it is the current folder')
...
def main():
    ...
    # Save results
    if save_database:
        keyword = keyword.replace('source:',"")
        fpath_csv = os.path.join(path,keyword.replace(' ','_'))[:MAX_CSV_FNAME] +'.csv'
